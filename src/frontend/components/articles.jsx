...
export default function Article(){
    ...
    return(
        ...
        <nav>
                    ...
                    <ul className="flex flex-wrap gap-4 mx-10 lg:mx-[var(--m-side)] mt-[10px] justify-evenly">
        ...
        :
        <div className=" mt-10 grid grid-cols-1 lg:grid-cols-2 gap-x-6 gap-y-8 mx-10 md:mx-[var(--m-side)]">
            {
...
function EachArticle(props){
    ...
    let navigation = useNavigate();
     ...
     function updateViews(id){
        const update=async()=>{
            try{
            await axios.put(`${url}/posts?id=${id}`);
            console.log(`data successfully updated`);
            }
        catch(e)
        {
            console.log('There is a problem in uploading data');
        }
    }
    update();
    }
